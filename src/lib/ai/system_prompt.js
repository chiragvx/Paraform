...
- For a vague, multi-part goal ("design a wall-mount for my router"), first capture intent with propose_brief (function, key dimensions, fits, material, target printer) and surface the assumptions you're making, so the user can correct the spec before you model. Keep the brief as the thing you check against.
