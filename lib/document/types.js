...
export const FEATURE_TYPES = {
    ...
    Foot:                 { category: CATEGORIES.CREATE,    label: 'Foot' },
    Gusset:               { category: CATEGORIES.CREATE,    label: 'Gusset' },
    Handle:               { category: CATEGORIES.CREATE,    label: 'Handle' },
    ShaftHub:             { category: CATEGORIES.CREATE,    label: 'Shaft Hub' },
    Lid:                  { category: CATEGORIES.CREATE,    label: 'Lid' },
    RackGear:             { category: CATEGORIES.CREATE,    label: 'Rack Gear' },
    BatteryHolder:        { category: CATEGORIES.CREATE,    label: 'Battery Holder' },
    DINRailClip:          { category: CATEGORIES.CREATE,    label: 'DIN Rail Clip' },
    CableClip:            { category: CATEGORIES.CREATE,    label: 'Cable Clip' },
    GridfinityBin:        { category: CATEGORIES.CREATE,    label: 'Gridfinity Bin' },
    TSlotBracket:         { category: CATEGORIES.CREATE,    label: 'T-Slot Bracket' },
    Impeller:             { category: CATEGORIES.CREATE,    label: 'Impeller' },
    Auger:                { category: CATEGORIES.CREATE,    label: 'Auger' },
    BlowerWheel:          { category: CATEGORIES.CREATE,    label: 'Blower Wheel' },
    PaddleWheel:          { category: CATEGORIES.CREATE,    label: 'Paddle Wheel' },
    PiCase:               { category: CATEGORIES.CREATE,    label: 'Raspberry Pi Case' },
