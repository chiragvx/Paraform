...
console.log('\n── src/lib/ai script guard (sandbox pre-check + typed-op redirect) ──');
await import('../../../src/lib/ai/__tests__/script_guard.test.mjs');

console.log('\n── src/lib/ai tool-surface efficiency (caching · generator meta-tools · triage) ──');
await import('../../../src/lib/ai/__tests__/tool_efficiency.test.mjs');

console.log('\n── src/lib/ai context window (send-time history compaction) ──');
await import('../../../src/lib/ai/__tests__/context_window.test.mjs');

console.log('\n── src/lib/ai loop brakes (anti-oscillation convergence guard) ──');
await import('../../../src/lib/ai/__tests__/loop_brakes.test.mjs');

console.log('\n── src/lib/ai stable prefix (system[0] byte-stable for prefix caching) ──');
await import('../../../src/lib/ai/__tests__/stable_prefix.test.mjs');
