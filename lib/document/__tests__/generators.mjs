...
await t('GENERATOR_TOOLS exposes every generator in the standard shape', () => {
    ...
    assert.deepEqual(names, [
        'addBearingPocket', 'addBracket', 'addFan', 'addFanBlade', 'addHinge', 'addKnob',
        'addMotorMount', 'addMountingPlate', 'addNutTrap', 'addPCBTray', 'addProjectBox',
        'addPulley', 'addScrewBoss', 'addShaftCoupler', 'addSnapHook', 'addSprocket',
        'addStandoff', 'addThreadedInsertBoss', 'addTSlotExtrusion', 'addTimingPulley', 'addWheel',
    ].sort());
