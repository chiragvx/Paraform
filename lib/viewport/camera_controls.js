 ...
 *   controls.enableDamping   : boolean       — accepted but our damping is
 *                                              internal, no-op for now
 *   controls.dampingFactor   : number        — same
...
export class CADCameraControls extends THREE.EventDispatcher {
    ...
    _startCoast() {
        ...
        const tick = () => {
            ...
            // Exponential decay: a = exp(-dt / tau), tau ≈ DECAY_MS / 3 so
            // we hit ~5% at DECAY_MS.
            const tau = DAMPING_DECAY_MS / 3;
